//
//  SucceedingDelegateViewController.swift
//  IntegrationTester
//
...
class SucceedingDelegateViewController: BasisTheoryUIViewController {
    ...
    // not able to implement this method.. which is what we want!
